...
/* base64 which allows line breaks */
Base64 "base64"
 = [A-Za-z0-9+\/=\r\n]
...
Label "label"
 = name:IdentifierPart+ !ReservedWord {
   return {
     type: "Label",
     name: name.join("")
   };
...
// Tokens
//
tkInbox    = "inbox"i    !IdentifierPart
tkOutbox   = "outbox"i   !IdentifierPart
tkCopyFrom = "copyfrom"i !IdentifierPart
tkCopyTo   = "copyto"i   !IdentifierPart
tkAdd      = "add"i      !IdentifierPart
tkSub      = "sub"i      !IdentifierPart
tkBumpUp   = "bumpup"i   !IdentifierPart
tkBumpDn   = "bumpdn"i   !IdentifierPart
tkJump     = "jump"i     !IdentifierPart
tkJumpZero = "jumpz"i    !IdentifierPart
tkJumpNeg  = "jumpn"i    !IdentifierPart
tkDefine   = "define"i   !IdentifierPart
tkComment  = "comment"i  !IdentifierPart
// CAW: Not sure if this should be a Reserved Word
tkLabel    = "label"i    !IdentifierPart
